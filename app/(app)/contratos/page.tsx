    ...
    <div>
      <div className="flex justify-between items-end mb-5 pb-4 border-b border-line gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-ink-soft mt-1">Onde imóvel + partes + condições se juntam. É este número que toda demanda jurídica referencia.</p>
        </div>
      ...
      <ExplainBox>
        <strong>Para que serve:</strong> cada linha é a identidade jurídica de uma locação ou venda — reúne imóvel, pessoas e condições. É o contrato, não o imóvel, que uma demanda jurídica vincula.
      </ExplainBox>
